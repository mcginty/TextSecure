    ...
    implements ConversationFragment.ConversationFragmentListener
{
  ...
  public void updateSendButtonState() {
    if (Util.isEmpty(composeText.getText()) && !attachmentManager.isAttachmentPresent()) {
      disableSendButton();
    } else {
      enableSendButton();
    }
  ...
  private void disableSendButton() {
    ...
    sendButton.setColorFilter(new PorterDuffColorFilter(0x99999999, PorterDuff.Mode.SRC_IN));
  }
