  ...
  private class PushMessagingClickListener implements Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(final Preference preference, Object newValue) {
      if (((CheckBoxPreference)preference).isChecked()) {
        ...
        builder.setNegativeButton(getString(R.string.ApplicationPreferencesActivity_keep_enabled), null);
        builder.setPositiveButton(getString(R.string.ApplicationPreferencesActivity_disable), new DialogInterface.OnClickListener() {
          @Override
