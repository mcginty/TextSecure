...
public class PlaintextBackupImporter {
  ...
  public static void importPlaintextFromSd(Context context, MasterSecret masterSecret, ProgressListener progressListener)
      throws NoExternalStorageException, IOException
  {
    ...
    importPlaintext(context, masterSecret, reader, progressListener);
  }
  ...
  public static void importPlaintext(Context context, MasterSecret masterSecret, InputStream input, ProgressListener progressListener)
      throws IOException
  {
    ...
    try {
      ...
      String countAttribute = reader.getAttribute("count");
      int    progress = 0;
      int    count;
      try {
      ...
      while (reader.hasMoreChildren()) {
        ...
        reader.moveUp();
        if (progressListener != null) progressListener.onProgress(progress++, count);
      }
